 ...
 * subclass YoungChild inherits from superclass Child
 * YoungChild(dependent)
 * Description:
 * 
 ...
 *  A and C are the parent of C do not exist in this exercise. However an adult may have no connections.
