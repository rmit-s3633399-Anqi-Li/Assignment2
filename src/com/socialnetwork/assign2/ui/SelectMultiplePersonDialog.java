...
public class SelectMultiplePersonDialog extends  JDialog {
    ...
    public SelectMultiplePersonDialog(JFrame frm,String title1,String title2,String[] pDataArray1,String[] pDataArray2,ButtonCallBack btn1CallBack,ButtonCallBack btn2CallBack) {
        /*********************** UI initialization ***************************/
    ...
    private void UIlayout(){
        ...
        btOk.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				SelectMultiplePersonDialog.this.dispose();
